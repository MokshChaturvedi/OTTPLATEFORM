...
class WatchOnlineTablet extends StatefulWidget {
  const WatchOnlineTablet({super.key, this.title = 'Stranger Things '});

  final String title;

  @override
  State<StatefulWidget> createState() {
    return _WatchOnlineTabletState();
  }
}

class _WatchOnlineTabletState extends State<WatchOnlineTablet> {
